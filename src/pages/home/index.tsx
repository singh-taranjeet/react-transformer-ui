        ...
        answer: <div>
            ...
            <ul>
                <li class="px-2 py-1 flex">
                    <b class="font-semibold">Prefix</b>: {<div class="rounded bg-slate-200 px-2 w-fit">{'<<'}</div>} <i> To start a pattern</i>
                </li>
                <li class="px-2 py-1 flex">
                    <b class="font-semibold">Seperator</b>: <div class="rounded bg-slate-200 px-2 w-fit">{'|'}</div> <i> To divide different components of a pattern</i>
                </li>
                <li class="px-2 py-1 flex">
                    <b class="font-semibold">Suffix</b>: <div class="rounded bg-slate-200 px-2 w-fit">{'>>'}</div> <i> To end a pattern</i>
                </li>
                <li class="px-2 py-1 flex">
            ...
            <div class='mt-2 pb-2'>
            <p class='font-bold pb-2'>Following is an example how strings can get converted to:</p>
    ...
    return <article class="py-2">
        ...
        >
            <div class="pt-16 w-full container flex flex-col">
                ...
                <p class='text-white text-center pb-4 font-light px-2'>{'Convert simple string patterns to React components with React Transformer'}</p>
